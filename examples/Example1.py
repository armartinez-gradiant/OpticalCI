#!/usr/bin/env python3
"""
🌟 Complete Photonic Simulation Demo - PtONN-TESTS
...
class PhotonicSimulationDemo:
    ...
    def demo_2_microring_spectral_response(self):
        ...
        if len(minima_indices) >= 2:
            ...
            fsr_measured = fsr_theoretical  # Fallback
        ...
        print(f"   FSR teórico: {fsr_theoretical*1e12:.1f} pm")
        print(f"   FSR medido: {fsr_measured*1e12:.1f} pm")
        ...
        return {
            ...
            'fsr_measured_pm': fsr_measured.item() * 1e12,
            'energy_conservation': energy_conservation.item(),
    ...
    def demo_3_add_drop_mrr_transfer(self):
        ...
        print(f"   Through power: {through_out.cpu().numpy():.3f}")
        print(f"   Drop power: {drop_out.cpu().numpy():.3f}")
