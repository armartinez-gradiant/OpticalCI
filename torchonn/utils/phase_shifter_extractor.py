"""
PhaseShifterExtractor - Para torchonn/utils/phase_shifter_extractor.py
======================================================================

Módulo para extraer valores de phase shifters de modelos ONN entrenados.
Integrado en la estructura de OpticalCI.

Ubicación: /workspaces/OpticalCI/torchonn/utils/phase_shifter_extractor.py
"""
...
class PhaseShifterExtractor:
    """
    Extractor de valores de phase shifters para modelos ONN.
    ...
    Uso básico:
        ...
        extractor.save_to_file(values, "weights.json")
    """
...
def quick_apply(model: nn.Module, weights_file: str):
    ...
    USO:
        from torchonn.utils.phase_shifter_extractor import quick_apply
...
def quick_summary(model: nn.Module):
    """
    Función rápida para ver resumen.
    
    USO:
        from torchonn.utils.phase_shifter_extractor import quick_summary
        quick_summary(my_model)
    """
    extractor = PhaseShifterExtractor()
    values = extractor.extract(model)
    extractor.print_summary(values)
